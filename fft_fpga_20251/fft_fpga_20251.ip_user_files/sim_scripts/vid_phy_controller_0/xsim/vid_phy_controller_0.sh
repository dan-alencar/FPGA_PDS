...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L vid_phy_controller_v2_2_22"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_22 -L vid_phy_controller_v2_2_22 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vid_phy_controller_0 xil_defaultlib.vid_phy_controller_0 xil_defaultlib.glbl -log elaborate.log
}
