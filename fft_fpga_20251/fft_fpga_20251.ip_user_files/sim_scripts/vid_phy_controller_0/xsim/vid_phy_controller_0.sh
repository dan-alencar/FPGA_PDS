...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L vid_phy_controller_v2_2_20"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_20 -L vid_phy_controller_v2_2_20 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vid_phy_controller_0 xil_defaultlib.vid_phy_controller_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vid_phy_controller_0 -key {Behavioral:sim_1:Functional:vid_phy_controller_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vid_phy_controller_0.wdb xsim.dir libdpi.so)
