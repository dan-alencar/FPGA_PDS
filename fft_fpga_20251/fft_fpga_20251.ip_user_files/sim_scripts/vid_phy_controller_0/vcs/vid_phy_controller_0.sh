...
design_libs=(xilinx_vip xpm gtwizard_ultrascale_v1_7_20 xil_defaultlib vid_phy_controller_v2_2_20)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_20 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vhdlan -work vid_phy_controller_v2_2_20 $vhdlan_opts \
  "../../../ipstatic/hdl/src/vhd/nidru_20_v_7.vhd" \
  "../../../ipstatic/hdl/src/vhd/bs_flex_v_2.vhd" \
  "../../../ipstatic/hdl/src/vhd/nidru_20_wrapper.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work vid_phy_controller_v2_2_20 $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/src/verilog/vid_phy_controller_v2_2_lib.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work vid_phy_controller_v2_2_20 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/danilo-alencar/Documents/GitHub/FPGA_PDS/fft_fpga_20251/fft_fpga_20251.cache/compile_simlib/vcs"
  fi
