...
#
# Script generated by Vivado on Mon Jan 19 17:12:49 -03 2026
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname gtwizard_ultrascale_v1_7_20 -libname xil_defaultlib -libname vid_phy_controller_v2_2_20 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm gtwizard_ultrascale_v1_7_20 xil_defaultlib vid_phy_controller_v2_2_20)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "vid_phy_controller_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_20 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvhdl -work vid_phy_controller_v2_2_20 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/src/vhd/nidru_20_v_7.vhd" \
  "../../../ipstatic/hdl/src/vhd/bs_flex_v_2.vhd" \
  "../../../ipstatic/hdl/src/vhd/nidru_20_wrapper.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work vid_phy_controller_v2_2_20 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/src/verilog/vid_phy_controller_v2_2_lib.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work vid_phy_controller_v2_2_20 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" +incdir+"/home/danilo-alencar/AMD/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vid_phy_controller_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vid_phy_controller_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/danilo-alencar/Documents/GitHub/FPGA_PDS/fft_fpga_20251/fft_fpga_20251.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vid_phy_controller_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
