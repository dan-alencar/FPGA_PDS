...
#
# Script generated by Vivado on Wed Jan 21 10:33:10 -03 2026
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname gtwizard_ultrascale_v1_7_22 -libname xil_defaultlib -libname vid_phy_controller_v2_2_22 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm gtwizard_ultrascale_v1_7_22 xil_defaultlib vid_phy_controller_v2_2_22)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_22 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work vid_phy_controller_v2_2_22 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/src/verilog/vid_phy_controller_v2_2_lib.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work vid_phy_controller_v2_2_22 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"/home/dan-alencar/2025.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dan-alencar/Documents/GitHub/FPGA_PDS/fft_fpga_20251/fft_fpga_20251.cache/compile_simlib/xcelium"
  fi
