...
HD_PWD='C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_tx_bd_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_tx_bd_proc_sys_reset_0_0.tcl
