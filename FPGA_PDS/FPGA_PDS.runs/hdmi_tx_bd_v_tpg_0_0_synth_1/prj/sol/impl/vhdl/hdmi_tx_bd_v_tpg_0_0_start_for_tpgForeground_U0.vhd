...
entity hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0 is 
    generic (
...
architecture rtl of hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0 is
...
------------------------Component----------------------
    component hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg : hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg
    generic map (
...
entity hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg;

architecture rtl of hdmi_tx_bd_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is
