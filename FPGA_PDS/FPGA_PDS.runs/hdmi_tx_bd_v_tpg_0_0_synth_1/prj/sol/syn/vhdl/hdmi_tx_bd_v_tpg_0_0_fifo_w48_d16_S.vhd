...
entity hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S is 
    generic (
...
architecture rtl of hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S is
...
------------------------Component----------------------
    component hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 48;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg : hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg
    generic map (
...
entity hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 48;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg;

architecture rtl of hdmi_tx_bd_v_tpg_0_0_fifo_w48_d16_S_ShiftReg is
