...
HD_PWD='C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_rst_microblaze_0_clk_wiz_1_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_tx_bd_rst_microblaze_0_clk_wiz_1_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_tx_bd_rst_microblaze_0_clk_wiz_1_100M_1.tcl
