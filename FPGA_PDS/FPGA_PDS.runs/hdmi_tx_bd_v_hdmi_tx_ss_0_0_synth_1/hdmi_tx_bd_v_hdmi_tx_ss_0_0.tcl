...
namespace eval ::optrace {
  variable script "C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0.tcl"
...
OPTRACE "hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.srcs/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0.xci
...
set cacheID [config_ip_cache -export -no_bom  -dir C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1 -new_name hdmi_tx_bd_v_hdmi_tx_ss_0_0 -ip [get_ips hdmi_tx_bd_v_hdmi_tx_ss_0_0]]
...
synth_design -top hdmi_tx_bd_v_hdmi_tx_ss_0_0 -part xcau15p-ffvb676-2-e -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix hdmi_tx_bd_v_hdmi_tx_ss_0_0_ hdmi_tx_bd_v_hdmi_tx_ss_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v
 lappend ipCachedFiles hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl
 lappend ipCachedFiles hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.v
 lappend ipCachedFiles hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.vhdl
 lappend ipCachedFiles hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp hdmi_tx_bd_v_hdmi_tx_ss_0_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips hdmi_tx_bd_v_hdmi_tx_ss_0_0]
 }
...
rename_ref -prefix_all hdmi_tx_bd_v_hdmi_tx_ss_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef hdmi_tx_bd_v_hdmi_tx_ss_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file hdmi_tx_bd_v_hdmi_tx_ss_0_0_utilization_synth.rpt -pb hdmi_tx_bd_v_hdmi_tx_ss_0_0_utilization_synth.pb"  } 
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0.dcp c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.v c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.runs/hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.vhdl c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.ip_user_files/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0]} {
  catch { 
    file copy -force c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.v C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.ip_user_files/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0
  }
}

if {[file isdir C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.ip_user_files/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0]} {
  catch { 
    file copy -force c:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.gen/sources_1/bd/hdmi_tx_bd/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0/hdmi_tx_bd_v_hdmi_tx_ss_0_0_stub.vhdl C:/AMDDesignTools/FPGA_PDS/FPGA_PDS/FPGA_PDS.ip_user_files/ip/hdmi_tx_bd_v_hdmi_tx_ss_0_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "hdmi_tx_bd_v_hdmi_tx_ss_0_0_synth_1" END { }
