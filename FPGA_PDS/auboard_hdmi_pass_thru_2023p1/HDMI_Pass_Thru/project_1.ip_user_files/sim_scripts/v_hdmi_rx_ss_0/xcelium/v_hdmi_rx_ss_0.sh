...
#
# Script generated by Vivado on Thu Jan 04 15:03:39 MST 2024
...
#
# Usage        : v_hdmi_rx_ss_0.sh
#                v_hdmi_rx_ss_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                v_hdmi_rx_ss_0.sh [-reset_run]
#                v_hdmi_rx_ss_0.sh [-reset_log]
#                v_hdmi_rx_ss_0.sh [-help]
#
...
#                script (type 'v_hdmi_rx_ss_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname v_hdmi_rx_v3_0_2 -libname xil_defaultlib -libname v_vid_in_axi4s_v5_0_2 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm v_hdmi_rx_v3_0_2 xil_defaultlib v_vid_in_axi4s_v5_0_2)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "v_hdmi_rx_ss_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./v_hdmi_rx_ss_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work v_hdmi_rx_v3_0_2 $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/v_hdmi_rx_v3_0_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/ip/v_hdmi_rx_ss_0/bd_0/ip/ip_0/sim/bd_2422_0_v_hdmi_rx_0.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work v_vid_in_axi4s_v5_0_2 $xmvlog_opts +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.v_hdmi_rx_ss_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.v_hdmi_rx_ss_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log v_hdmi_rx_ss_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: v_hdmi_rx_ss_0.sh [-step]\n\
Usage: v_hdmi_rx_ss_0.sh [-lib_map_path]\n\
Usage: v_hdmi_rx_ss_0.sh [-reset_run]\n\
Usage: v_hdmi_rx_ss_0.sh [-reset_log]\n\
Usage: v_hdmi_rx_ss_0.sh [-keep_index]\n\
