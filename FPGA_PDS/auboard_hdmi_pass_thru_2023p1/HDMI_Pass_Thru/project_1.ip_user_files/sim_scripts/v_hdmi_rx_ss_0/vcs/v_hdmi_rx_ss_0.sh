...
design_libs=(xilinx_vip xpm v_hdmi_rx_v3_0_2 xil_defaultlib v_vid_in_axi4s_v5_0_2)
...
compile()
{
  ...
  vlogan -work v_hdmi_rx_v3_0_2 $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/v_hdmi_rx_v3_0_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/ip/v_hdmi_rx_ss_0/bd_0/ip/ip_0/sim/bd_2422_0_v_hdmi_rx_0.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work v_vid_in_axi4s_v5_0_2 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key v_hdmi_rx_ss_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc v_hdmi_rx_ss_0_simv.daidir vcs_lib c.obj)
