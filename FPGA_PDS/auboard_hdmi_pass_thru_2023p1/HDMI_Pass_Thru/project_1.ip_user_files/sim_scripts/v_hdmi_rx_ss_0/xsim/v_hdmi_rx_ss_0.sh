...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L v_hdmi_rx_v3_0_2"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L v_hdmi_rx_v3_0_2 -L xil_defaultlib -L v_vid_in_axi4s_v5_0_2 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot v_hdmi_rx_ss_0 xil_defaultlib.v_hdmi_rx_ss_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb v_hdmi_rx_ss_0.wdb xsim.dir libdpi.so)
