...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_exdes_clk_wiz_1_clk_wiz is
  ...
  signal clk_out3_exdes_clk_wiz_1 : STD_LOGIC;
...
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_exdes_clk_wiz_1,
      O => clk_out3
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 86.625000,
      ...
      CLKOUT2 => clk_out3_exdes_clk_wiz_1,
