...
architecture behav of exdes_v_tpg_0_v_tpg is 
    ...
    "exdes_v_tpg_0_v_tpg,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcau15p-ffvb676-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.707187,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2870,HLS_SYN_LUT=7191,HLS_VERSION=2023_1}";
