...
HD_PWD='/home/training/AUPBoard/HDMI_Pass_Thru_ExDes/v_hdmi_rx_ss_0_ex/v_hdmi_rx_ss_0_ex.runs/exdes_mdm_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exdes_mdm_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exdes_mdm_0.tcl
