...
/*
	Capture
*/
module hdmi_acr_ctrl_v1_0_1_lib_cap
(
...
/*
	Reset synchronizer
*/
module hdmi_acr_ctrl_v1_0_1_lib_rst
(
...
*/
module hdmi_acr_ctrl_v1_0_1_lib_cdc
#(
...
module hdmi_acr_ctrl_v1_0_1_lib_pls_cdc
( 
   input wire SRC_RST_IN,
   input wire SRC_CLK_IN,
...
module hdmi_acr_ctrl_v1_0_1_lib_pulse_clkcross
(
  input  in_clk,
  input  in_pulse,
  input  out_clk,
...
endmodule //hdmi_acr_ctrl_v1_0_1_lib_pulse_clkcross

module hdmi_acr_ctrl_v1_0_1_lib_data_clkcross #
(
...
endmodule //hdmi_acr_ctrl_v1_0_1_lib_data_clkcross
