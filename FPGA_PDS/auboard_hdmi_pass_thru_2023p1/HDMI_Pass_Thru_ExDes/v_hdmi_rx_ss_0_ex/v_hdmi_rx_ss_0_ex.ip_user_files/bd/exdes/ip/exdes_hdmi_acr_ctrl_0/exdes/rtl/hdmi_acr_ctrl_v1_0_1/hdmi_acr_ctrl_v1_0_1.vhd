...
entity hdmi_acr_ctrl_v1_0_1 is
...
end hdmi_acr_ctrl_v1_0_1;

architecture rtl of hdmi_acr_ctrl_v1_0_1 is
...
component hdmi_acr_ctrl_v1_0_1_top 
  port
  (
  -- AXI4-Lite bus (cpu control)
  axi_aclk    : in std_logic;
...
hdmi_acr_ctrl_top_inst : hdmi_acr_ctrl_v1_0_1_top
port map (
   -- AXI4-Lite bus (cpu control)
   axi_aclk               =>     axi_aclk   , 
