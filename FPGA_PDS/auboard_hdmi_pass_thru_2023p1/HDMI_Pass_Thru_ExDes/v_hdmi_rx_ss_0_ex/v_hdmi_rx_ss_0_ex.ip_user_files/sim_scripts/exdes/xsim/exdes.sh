...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L vid_phy_controller_v2_2_16 -L v_hdmi_tx_v3_0_2 -L v_hdmi_rx_v3_0_2"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb exdes.wdb xsim.dir libdpi.so)
