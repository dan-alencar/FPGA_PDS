...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bd_2339_v_axi4s_vid_out_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_2339_v_axi4s_vid_out_0,v_axi4s_vid_out_v4_0_20,{}" *) (* CORE_GENERATION_INFO = "bd_2339_v_axi4s_vid_out_0,v_axi4s_vid_out_v4_0_20,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_axi4s_vid_out,x_ipVersion=4.0,x_ipCoreRevision=20,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=kintexuplus,C_PIXELS_PER_CLOCK=2,C_COMPONENTS_PER_PIXEL=3,C_S_AXIS_COMPONENT_WIDTH=8,C_NATIVE_COMPONENT_WIDTH=8,C_NATIVE_DATA_WIDTH=48,C_S_AXIS_TDATA_WIDTH=48,C_HAS_ASYNC_CLK=1,C_ADDR_WIDTH=10,C_VTG_MASTER_SLAVE=0,C_HYSTERESIS_LEVEL=12,C_SYNC_LOCK_THRESHOLD=4,C_INCLUDE_PIXEL_REPEAT=1,C_INCLUDE_PIXEL_REMAP_420=1,C_ADDR_WIDTH_PIXEL_REMAP_420=11,C_ARBITRARY_RES_EN=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="aclken,aresetn,s_axis_video_tdata[47:0],s_axis_video_tvalid,s_axis_video_tready,s_axis_video_tuser,s_axis_video_tlast,fid,vid_io_out_ce,vid_io_out_reset,vid_active_video,vid_vsync,vid_hsync,vid_vblank,vid_hblank,vid_field_id,vid_data[47:0],vtg_vsync,vtg_hsync,vtg_vblank,vtg_hblank,vtg_active_video,vtg_field_id,vtg_ce,video_format[1:0],locked,overflow,underflow,fifo_read_level[10:0],status[31:0],sof_state_out,repeat_en,remap_420_en" */
/* synthesis syn_force_seq_prim="aclk" */
/* synthesis syn_force_seq_prim="vid_io_out_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk_intf CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk_intf, ASSOCIATED_BUSIF video_in, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_microblaze_0_clk_wiz_1_0_clk_out1, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
