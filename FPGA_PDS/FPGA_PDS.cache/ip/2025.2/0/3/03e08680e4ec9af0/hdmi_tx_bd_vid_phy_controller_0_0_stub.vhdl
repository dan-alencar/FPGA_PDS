...
-- Date        : Wed Jan 21 12:36:56 2026
-- Host        : dan-alencar running 64-bit Linux Mint 22.2
-- Command     : write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_tx_bd_vid_phy_controller_0_0_stub.vhdl
...
architecture stub of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of tx_tmds_clk : signal is "XIL_INTERFACENAME tx_tmds_clk, FREQ_HZ 297000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_tmds_clk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of tx_video_clk : signal is "XIL_INTERFACENAME tx_video_clk, FREQ_HZ 297000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_video_clk, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of tx_tmds_clk_p : signal is "xilinx.com:signal:clock:1.0 tx_tmds_clk_p CLK";
  attribute X_INTERFACE_MODE of tx_tmds_clk_p : signal is "master";
  attribute X_INTERFACE_PARAMETER of tx_tmds_clk_p : signal is "XIL_INTERFACENAME tx_tmds_clk_p, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_tmds_clk_p, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of tx_tmds_clk_n : signal is "xilinx.com:signal:clock:1.0 tx_tmds_clk_n CLK";
  attribute X_INTERFACE_MODE of tx_tmds_clk_n : signal is "master";
  attribute X_INTERFACE_PARAMETER of tx_tmds_clk_n : signal is "XIL_INTERFACENAME tx_tmds_clk_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_tmds_clk_n, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of mgtrefclk1_pad_p_in : signal is "xilinx.com:signal:clock:1.0 mgtrefclk1_pad_p_in CLK";
  attribute X_INTERFACE_MODE of mgtrefclk1_pad_p_in : signal is "slave";
  attribute X_INTERFACE_PARAMETER of mgtrefclk1_pad_p_in : signal is "XIL_INTERFACENAME mgtrefclk1_pad_p_in, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of mgtrefclk1_pad_n_in : signal is "xilinx.com:signal:clock:1.0 mgtrefclk1_pad_n_in CLK";
  attribute X_INTERFACE_MODE of mgtrefclk1_pad_n_in : signal is "slave";
  attribute X_INTERFACE_PARAMETER of mgtrefclk1_pad_n_in : signal is "XIL_INTERFACENAME mgtrefclk1_pad_n_in, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of txoutclk : signal is "XIL_INTERFACENAME txoutclk, FREQ_HZ 148500000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_txoutclk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of vid_phy_tx_axi4s_ch1_tdata : signal is "XIL_INTERFACENAME vid_phy_tx_axi4s_ch1, WIZ.DATA_WIDTH 32, TDATA_NUM_BYTES 5, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 297000000, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_video_clk, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of vid_phy_tx_axi4s_ch2_tdata : signal is "XIL_INTERFACENAME vid_phy_tx_axi4s_ch2, WIZ.DATA_WIDTH 32, TDATA_NUM_BYTES 5, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 297000000, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_vid_phy_controller_0_0_tx_video_clk, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of vid_phy_sb_aclk : signal is "XIL_INTERFACENAME vid_phy_sb_CLK, ASSOCIATED_BUSIF vid_phy_control_sb_tx:vid_phy_status_sb_tx:vid_phy_control_sb_rx:vid_phy_status_sb_rx, ASSOCIATED_RESET vid_phy_sb_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_microblaze_0_clk_wiz_1_0_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of vid_phy_axi4lite_aclk : signal is "XIL_INTERFACENAME vid_phy_axi4lite_CLK, ASSOCIATED_BUSIF vid_phy_axi4lite, ASSOCIATED_RESET vid_phy_axi4lite_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_microblaze_0_clk_wiz_1_0_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of drpclk : signal is "XIL_INTERFACENAME drpclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_microblaze_0_clk_wiz_1_0_clk_out1, INSERT_VIP 0";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of stub : architecture is "hdmi_tx_bd_vid_phy_controller_0_0_top,Vivado 2025.2";
begin
end;
