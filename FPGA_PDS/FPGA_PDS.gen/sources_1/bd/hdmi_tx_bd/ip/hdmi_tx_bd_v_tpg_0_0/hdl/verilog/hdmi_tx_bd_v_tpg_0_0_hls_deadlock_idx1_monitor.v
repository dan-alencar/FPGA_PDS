...
module hdmi_tx_bd_v_tpg_0_0_hls_deadlock_idx1_monitor ( // for module hdmi_tx_bd_v_tpg_0_0_v_tpg_inst.grp_v_tpgHlsDataFlow_fu_525
    input wire clock,
    input wire reset,
...
// instant sub module
 hdmi_tx_bd_v_tpg_0_0_hls_deadlock_idx2_monitor hdmi_tx_bd_v_tpg_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
