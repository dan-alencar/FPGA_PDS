...
// Command     : write_verilog -force -mode synth_stub -rename_top bd_8312_v_vid_in_axi4s_0 -prefix
//               bd_8312_v_vid_in_axi4s_0_ bd_8312_v_vid_in_axi4s_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_8312_v_vid_in_axi4s_0,v_vid_in_axi4s_v5_0_7,{}" *) (* CORE_GENERATION_INFO = "bd_8312_v_vid_in_axi4s_0,v_vid_in_axi4s_v5_0_7,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_vid_in_axi4s,x_ipVersion=5.0,x_ipCoreRevision=7,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=kintexuplus,C_PIXELS_PER_CLOCK=2,C_COMPONENTS_PER_PIXEL=3,C_M_AXIS_COMPONENT_WIDTH=8,C_NATIVE_COMPONENT_WIDTH=8,C_NATIVE_DATA_WIDTH=48,C_M_AXIS_TDATA_WIDTH=48,C_HAS_ASYNC_CLK=1,C_ADDR_WIDTH=10,C_INCLUDE_PIXEL_DROP=1,C_INCLUDE_PIXEL_REMAP_420=1,C_ADDR_WIDTH_PIXEL_REMAP_420=11,C_VID_NATIVE_DE=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "v_vid_in_axi4s_v5_0_7,Vivado 2025.2" *) 
module bd_8312_v_vid_in_axi4s_0(vid_io_in_clk, vid_io_in_ce, vid_io_in_reset, 
  vid_active_video, vid_vblank, vid_hblank, vid_vsync, vid_hsync, vid_field_id, vid_data, 
  vid_format, aclk, aclken, aresetn, m_axis_video_tdata, m_axis_video_tvalid, 
  m_axis_video_tready, m_axis_video_tuser, m_axis_video_tlast, fid, vtd_active_video, 
  vtd_vblank, vtd_hblank, vtd_vsync, vtd_hsync, vtd_field_id, overflow, underflow, axis_enable, 
  drop_en, remap_420_en)
/* synthesis syn_black_box black_box_pad_pin="vid_io_in_ce,vid_io_in_reset,vid_active_video,vid_vblank,vid_hblank,vid_vsync,vid_hsync,vid_field_id,vid_data[47:0],vid_format[1:0],aclken,aresetn,m_axis_video_tdata[47:0],m_axis_video_tvalid,m_axis_video_tready,m_axis_video_tuser,m_axis_video_tlast,fid,vtd_active_video,vtd_vblank,vtd_hblank,vtd_vsync,vtd_hsync,vtd_field_id,overflow,underflow,axis_enable,drop_en,remap_420_en" */
...
/* synthesis syn_force_seq_prim="aclk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk_intf CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk_intf, ASSOCIATED_BUSIF video_out, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN hdmi_tx_bd_microblaze_0_clk_wiz_1_0_clk_out1, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
